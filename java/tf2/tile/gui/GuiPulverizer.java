...
public class GuiPulverizer extends GuiContainer {
	private final static ResourceLocation GUI_BACKGROUND = new ResourceLocation("tf2:textures/gui/container/pulverizer.png");

	private TileEntityPulverizer tileEntity;

	public GuiPulverizer(EntityPlayer inventory, TileEntityPulverizer tileEntity)
	{
		super(new ContainerPulverizer(inventory, tileEntity));
	...
	protected void drawGuiContainerBackgroundLayer(float partialRenderTick, int xMouse, int yMouse)
	{
		...
		if (this.tileEntity.isBurning())
		{
			...
			this.drawTexturedModalRect(x + 43, y + 36 + 13 - i1, 176, 13 - i1, 24, i1 + 1);

			i1 = this.tileEntity.getCookProgressScaled(27);
			this.drawTexturedModalRect(x + 75, y + 34, 176, 14, i1 + 1, 19);
		}
	}
}