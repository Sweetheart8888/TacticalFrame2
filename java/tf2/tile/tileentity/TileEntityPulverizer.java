...
public class TileEntityPulverizer extends TileEntity implements ITickable, ISidedInventory
{
	public int burnTime;
	...
	public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            if (this.burnTime != 0 || !itemstack1.isEmpty() && !itemstack0.isEmpty())
            {
	...
	private boolean canSmelt()
	{
		...
		{
			ItemStack itemstack = PulverizerRecipes.instance().getSmeltingResult(this.furnaceItemStacks.get(0));
	...
	public void smeltItem()
    {
        ...
        {
        	ItemStack itemstack0 = this.furnaceItemStacks.get(0);
			ItemStack itemstack1 = PulverizerRecipes.instance().getSmeltingResult(itemstack0);
	...
	public boolean isItemValidForSlot(int index, ItemStack stack)
	{
		...
		{
			return !PulverizerRecipes.instance().getSmeltingResult(stack).isEmpty();
		}
		else
		{
