...
public class RenderMTT1 extends Render
{
	private static final ResourceLocation tftexture = new ResourceLocation("tf2:textures/mob/mtt1.png");
	private static final ResourceLocation tfeyes = new ResourceLocation("tf2:textures/mob/mtt1_light.png");
	private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("tf2:textures/mob/mtt1.obj"));

	public RenderMTT1(RenderManager renderManager)
	{
		super(renderManager);
	}
	...
	{
		this.doRender((EntityMTT1) p_76986_1_, entityX, entityY, entityZ, p_76986_8_, p_76986_9_);
	...
	public void doRender(EntityMTT1 p_76986_1_, double entityX, double entityY, double entityZ, float p_76986_8_, float p_76986_9_)
	{
