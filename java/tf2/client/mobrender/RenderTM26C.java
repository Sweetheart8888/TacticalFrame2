...
public class RenderTM26C extends Render
{
	private static final ResourceLocation tftexture = new ResourceLocation("tf2:textures/mob/tm26c.png");
	private static final ResourceLocation tfeyes = new ResourceLocation("tf2:textures/mob/tm26ceye.png");
	private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("tf2:textures/mob/tm26c.obj"));

	public RenderTM26C(RenderManager renderManager)
	{
		super(renderManager);
	}
	...
	{
		this.doRender((EntityTM26C) entity, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
	}

	public void doRender(EntityTM26C entity, double entityX, double entityY, double entityZ, float p_76986_8_, float p_76986_9_)
	{
	...
	private void renderlegs(EntityTM26C entity)
	{
		float x = entity.ticksExisted;
