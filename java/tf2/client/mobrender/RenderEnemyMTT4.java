...
public class RenderEnemyMTT4 extends Render
{
	private static final ResourceLocation tftexture = new ResourceLocation("tf2:textures/mob/mtt4_enemy.png");
	private static final ResourceLocation tfeyes = new ResourceLocation("tf2:textures/mob/mtt4_light.png");
	private static final IModelCustom tankk = AdvancedModelLoader.loadModel(new ResourceLocation("tf2:textures/mob/mtt4.obj"));

	public RenderEnemyMTT4(RenderManager renderManager)
	{
		super(renderManager);
	}
	...
	{
		this.doRender((EntityEnemyMTT4) p_76986_1_, entityX, entityY, entityZ, p_76986_8_, p_76986_9_);
	...
	public void doRender(EntityEnemyMTT4 p_76986_1_, double entityX, double entityY, double entityZ, float p_76986_8_, float p_76986_9_)
	{
	...
	private void renderhead(EntityEnemyMTT4 p_76986_1_)
	{
		GlStateManager.pushMatrix();
