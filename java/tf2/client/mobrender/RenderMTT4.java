...
public class RenderMTT4 extends Render
{
	private static final ResourceLocation tftexture = new ResourceLocation("tf2:textures/mob/mtt4.png");
	...
	public RenderMTT4(RenderManager renderManager)
	{
		super(renderManager);
	}
	...
	{
		this.doRender((EntityMTT4) p_76986_1_, entityX, entityY, entityZ, p_76986_8_, p_76986_9_);
	...
	public void doRender(EntityMTT4 p_76986_1_, double entityX, double entityY, double entityZ, float p_76986_8_, float p_76986_9_)
	{
	...
	private void renderhead(EntityMTT4 p_76986_1_)
	{
		GlStateManager.pushMatrix();
