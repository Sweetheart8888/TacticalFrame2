...
{
    private static final CokeOvenRecipes SMELTING_BASE = new CokeOvenRecipes();
    ...
    {
    	this.addSmeltingRecipe(new ItemStack(Items.COAL, 1, 0), new ItemStack(TFItems.COKE), 0.1F);
        this.addSmeltingRecipeForBlock(Blocks.COAL_ORE, new ItemStack(TFItems.COKE, 2), 0.2F);
        this.addSmeltingRecipeForBlock(Blocks.COAL_BLOCK, new ItemStack(TFBlocks.COKE_BLOCK), 0.9F);
    }
    /**
