...
public class EntityAIFollowFriendMecha extends EntityAIBase
{
    private final EntityFriendMecha tameable;
    ...
    public EntityAIFollowFriendMecha(EntityFriendMecha tameableIn, double followSpeedIn, float minDistIn, float maxDistIn)
    {
    ...
    public boolean shouldExecute()
    {
        ...
        else if (this.tameable.getMechaMode() != 1)
        {
            return false;
        }
        else if(this.tameable.motionX > 0.004D || this.tameable.motionZ > 0.004D)
        {
        	return false;
        }
        else if(this.tameable.motionX < -0.004D || this.tameable.motionZ < -0.004D)
    ...
    {
        return !this.petPathfinder.noPath() && this.tameable.getDistanceSq(this.owner) > (double)(this.maxDist * this.maxDist) && this.tameable.getMechaMode() == 1;
    }
    ...
    public void updateTask()
    {
        ...
        if (this.tameable.getMechaMode() == 1)
        {
