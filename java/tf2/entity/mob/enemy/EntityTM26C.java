...
import tf2.entity.mob.ai.EntityAICharge;
import tf2.entity.mob.ai.EntityAIStepFront;

public class EntityTM26C extends EntityMobTF
{

	public EntityTM26C(World worldIn)
	{
		super(worldIn);
	...
	protected void initEntityAI()
	{
		...
		this.tasks.addTask(2, new EntityAICharge(this, 20D));
