...
public class ItemReliefSquad extends ItemSkillBase
{
	private final int coolTime;
	public ItemReliefSquad(String name, int cooltime)
	{
		super(name);
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
	{
		...
		if (!worldIn.isRemote)
		 {
			EntityAreaHeal entityenderpearl = new EntityAreaHeal(worldIn, playerIn);
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
	{
        ...
        {
        	tooltip.add(TextFormatting.BLUE + " " + I18n.translateToLocal("skill.reliefsquad"));
        }
        else
        {
