...
public class ItemFrontLine extends ItemSkillBase
{
	private final int coolTime;

	public ItemFrontLine(String name, int cooltime)
	{
		super(name);
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
	{
		...
		List entity = worldIn.getEntitiesWithinAABB(EntityMob.class, playerIn.getEntityBoundingBox().grow(35.0D));
		for (int i = 0; i < entity.size(); ++i)
		{
			EntityMob mob = (EntityMob) entity.get(i);
			mob.attackEntityFrom(DamageSource.causePlayerDamage(playerIn), 0F);

			mob.setAttackTarget(playerIn);
			mob.setLastAttackedEntity(playerIn);
		}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
	{
		...
		{
			tooltip.add(TextFormatting.BLUE + " " + I18n.translateToLocal("skill.frontline"));
		}
		else
		{
