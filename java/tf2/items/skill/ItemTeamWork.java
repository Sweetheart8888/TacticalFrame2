...
public class ItemTeamWork extends ItemSkillBase
{
	private final int coolTime;

	public ItemTeamWork(String name, int cooltime)
	{
		super(name);
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
	{
		...
		List entity = worldIn.getEntitiesWithinAABB(EntityPlayer.class, playerIn.getEntityBoundingBox().grow(10.0D));
 		for (int i = 0; i < entity.size(); ++i)
 		{
 			...
 			if (player != playerIn && !worldIn.isRemote)
 			{
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
	{
        ...
        {
        	tooltip.add(TextFormatting.BLUE + " " + I18n.translateToLocal("skill.teamwork"));
        }
        else
        {
