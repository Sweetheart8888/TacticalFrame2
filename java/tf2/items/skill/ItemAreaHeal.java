...
public class ItemAreaHeal extends ItemSkillBase
{
	private final int coolTime;
	public ItemAreaHeal(String name, int cooltime)
	{
		super(name);
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
	{
        ...
        {
        	tooltip.add(TextFormatting.BLUE + I18n.translateToLocal("effect.heal") + " +8");
