...
public class ItemRigidoArmor extends ItemArmor implements IHasModel
{
	private String tex;

	public ItemRigidoArmor(String name,ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn)
	{
