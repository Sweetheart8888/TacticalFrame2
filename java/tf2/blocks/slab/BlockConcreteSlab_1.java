...
public class BlockConcreteSlab_1 extends BlockSlab implements IHasModel
{
    public static final PropertyEnum<BlockConcreteSlab_1.Variant> VARIANT = PropertyEnum.<BlockConcreteSlab_1.Variant>create("variant", BlockConcreteSlab_1.Variant.class);

    public BlockConcreteSlab_1(String name)
    {
        ...
        this.setDefaultState(iblockstate.withProperty(VARIANT, BlockConcreteSlab_1.Variant.DEFAULT));
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
    	...
    	if(item == Item.getItemFromBlock(this))
    	{
    		...
    		{
    			worldIn.setBlockState(new BlockPos(pos.getX(), pos.getY(), pos.getZ()), TFBlocks.CONCRETE.getStateFromMeta(1), 2);
    ...
    protected static boolean isHalfSlab(IBlockState state)
    {
        ...
        return block == TFBlocks.CONCRETE_SLAB_1;
    }

    public Item getItemDropped(IBlockState state, Random rand, int fortune)
    {
        return Item.getItemFromBlock(TFBlocks.CONCRETE_SLAB_1);
    }

    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        return new ItemStack(TFBlocks.CONCRETE_SLAB_1);
    }
    ...
    {
        IBlockState iblockstate = this.getDefaultState().withProperty(VARIANT, BlockConcreteSlab_1.Variant.DEFAULT);
    ...
    {
        return BlockConcreteSlab_1.Variant.DEFAULT;
    }
