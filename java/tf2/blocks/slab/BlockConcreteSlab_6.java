...
public class BlockConcreteSlab_6 extends BlockSlab implements IHasModel
{
    public static final PropertyEnum<BlockConcreteSlab_6.Variant> VARIANT = PropertyEnum.<BlockConcreteSlab_6.Variant>create("variant", BlockConcreteSlab_6.Variant.class);

    public BlockConcreteSlab_6(String name)
    {
        ...
        this.setDefaultState(iblockstate.withProperty(VARIANT, BlockConcreteSlab_6.Variant.DEFAULT));
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
    	...
    	if(item == Item.getItemFromBlock(this))
    	{
    		...
    		{
    			worldIn.setBlockState(new BlockPos(pos.getX(), pos.getY(), pos.getZ()), TFBlocks.CONCRETE.getStateFromMeta(6), 2);
    ...
    protected static boolean isHalfSlab(IBlockState state)
    {
        ...
        return block == TFBlocks.CONCRETE_SLAB_6;
    }

    public Item getItemDropped(IBlockState state, Random rand, int fortune)
    {
        return Item.getItemFromBlock(TFBlocks.CONCRETE_SLAB_6);
    }

    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        return new ItemStack(TFBlocks.CONCRETE_SLAB_6);
    }
    ...
    {
        IBlockState iblockstate = this.getDefaultState().withProperty(VARIANT, BlockConcreteSlab_6.Variant.DEFAULT);
    ...
    {
        return BlockConcreteSlab_6.Variant.DEFAULT;
    }
