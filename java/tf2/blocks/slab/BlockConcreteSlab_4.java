...
public class BlockConcreteSlab_4 extends BlockSlab implements IHasModel
{
    public static final PropertyEnum<BlockConcreteSlab_4.Variant> VARIANT = PropertyEnum.<BlockConcreteSlab_4.Variant>create("variant", BlockConcreteSlab_4.Variant.class);

    public BlockConcreteSlab_4(String name)
    {
        ...
        this.setDefaultState(iblockstate.withProperty(VARIANT, BlockConcreteSlab_4.Variant.DEFAULT));
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
    	...
    	if(item == Item.getItemFromBlock(this))
    	{
    		...
    		{
    			worldIn.setBlockState(new BlockPos(pos.getX(), pos.getY(), pos.getZ()), TFBlocks.CONCRETE.getStateFromMeta(4), 2);
    ...
    protected static boolean isHalfSlab(IBlockState state)
    {
        ...
        return block == TFBlocks.CONCRETE_SLAB_4;
    }

    public Item getItemDropped(IBlockState state, Random rand, int fortune)
    {
        return Item.getItemFromBlock(TFBlocks.CONCRETE_SLAB_4);
    }

    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        return new ItemStack(TFBlocks.CONCRETE_SLAB_4);
    }
    ...
    {
        IBlockState iblockstate = this.getDefaultState().withProperty(VARIANT, BlockConcreteSlab_4.Variant.DEFAULT);
    ...
    {
        return BlockConcreteSlab_4.Variant.DEFAULT;
    }
